...
<head>
    ...
    <script>
        function FormValidate() {
            ...
            document.getElementById("error-messages").innerText = errorMessage;

            // Submit the form only if password is valid
            return isValid;
        }
    </script>
</head>
                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                <h1 class="text-center fw-bold mb-5 mt-4">Reset Password</h1>
                                <form class="mx-1 mx-md-4" action="ForgetController" method="post" onsubmit="return FormValidate()">
                                    ...
                                    <div class="form-group">
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="password" id="password" name="password"
                                                   class="form-control" placeholder="Reset Password" required>
                                        </div>
                                    </div>
                                    <div id="error-messages" style="color: red;"></div>
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-lg btn-block btn-custom">Reset Password</button>
                                    </div>
                                </form>
