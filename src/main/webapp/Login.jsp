...
<head>
    ...
    <style>
        ...
        .form-control-icon {
            position: absolute;
            left: 10px; /* Adjusted position for the icons */
            top: 50%;
                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                <h1 class="text-center fw-bold mb-5 mt-4">Log in</h1>
                                <form class="mx-1 mx-md-4" action="Logincontroller" method="post">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-lg btn-block btn-custom">Log in</button>
                                    </div>
                                    <div class="form-group">
                                        <a href="DashboardController?action=ForgetPassword" class="btn btn-lg btn-block btn-custom">Forget password</a>
                                    </div>
                                </form>
                            </div>
